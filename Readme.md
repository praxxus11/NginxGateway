This is the gateway for all my personal projects. This runs inside docker and shares the same bridge network as all other services. Currently, all services run inside one Oracle always-free tier compute instance. Requests are proxied through CloudFlare.
